<x-layout>
    <x-card class="p-10 max-w-lg mx-auto mt-24">
        <header class="text-center">
            ...
            <p class="mb-4">Edit : {{ $listing->business_name }}</p>
        </header>
        ...
        <form action="/bizcard/{{ $listing->id }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <input value="{{ $listing->tagline }}" type="text" class="border border-gray-200 rounded p-2 w-full"
            ...
            <div class="mb-6">
                ...
                <input value="{{ $listing->your_name }}"type="text" class="border border-gray-200 rounded p-2 w-full"
            ...
            <div class="mb-6">
                ...
                <input value="{{ $listing->job_title }}"type="text" class="border border-gray-200 rounded p-2 w-full"
            ...
            <div class="mb-6">
                ...
                <input value="{{ $listing->phone }}"type="text" class="border border-gray-200 rounded p-2 w-full"
            ...
            <div class="mb-6">
                ...
                <input type="text"
                    value="{{ $listing->physical_address }}"class="border border-gray-200 rounded p-2 w-full"
            ...
            <div class="mb-6">
                ...
                <input type="text" value="{{ $listing->linkedin }}"class="border border-gray-200 rounded p-2 w-full"
            ...
            <div class="mb-6">
                ...
                <input type="text" value="{{ $listing->twitter }}"class="border border-gray-200 rounded p-2 w-full"
            ...
            <div class="mb-6">
                ...
                <input type="text" value="{{ $listing->facebook }}"class="border border-gray-200 rounded p-2 w-full"
            ...
            <div class="mb-6">
                ...
                <input type="text"
                    value="{{ $listing->instagram }}"class="border border-gray-200 rounded p-2 w-full"
            ...
            <div class="mb-6">
                ...
                <input type="text"
                    value="{{ $listing->youtube }}"class="border border-gray-200 rounded p-2 w-full" name="youtube"
                    placeholder="" />
                @error('youtube')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            ...
            <div class="mb-6">
                ...
                <input type="text"
                    value="{{ $listing->pinterest }}"class="border border-gray-200 rounded p-2 w-full"
