     ...
     <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-24 lg:px-6">
         <div class="max-w-screen-md mx-auto mb-8 text-center lg:mb-12">
             <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">Affordable Plans
                 for Your Digital Advantage</h2>
             <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">Choose Your Perfect Plan for
                 Seamless Networking</p>
         </div>
         <div class="space-y-8 lg:grid lg:grid-cols-2 sm:gap-6 xl:gap-10 lg:space-y-0">
             ...
             <div
                 ...
                 <h3 class="mb-4 text-2xl font-semibold">Starter Free</h3>
                 ...
                 <ul role="list" class="mb-8 space-y-4 text-left">
                     <li class="flex items-center space-x-3">
                         ...
                         <span>Create up to <span class="font-semibold">4</span> stunning QR business cards</span>
                     </li>
                     <li class="flex items-center space-x-3">
                         <!-- Icon -->
                         <svg class="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" fill="currentColor"
                         ...
                         <span>Showcase your brand with a choice of <span class="font-semibold">pre-designed
                                 styles</span></span>
                     </li>
                     <li class="flex items-center space-x-3">
                         <!-- Icon -->
                         ...
                         <span><span class="font-semibold">Attach documents</span> to your cards for enhanced
                             engagement</span>
                     </li>
                     <li class="flex items-center space-x-3">
                         <!-- Icon -->
                         ...
                         <span><span class="font-semibold">Save contact</span> details directly to your device with
                             QR scan <span class="font-semibold">6 months</span></span>
                     </li>
                     <li class="flex items-center space-x-3">
                         <!-- Icon -->
                         <svg class="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" fill="currentColor"
                         ...
                         <span>Explore the power of digital networking at<span class="font-semibold"> no
                                 cost</span></span>
                     </li>
                 </ul>
                 <a href="#"
             ...
             <div
                 ...
                 <div class="flex items-baseline justify-center my-8">
                     ...
                     {{-- <span class="text-gray-500 dark:text-gray-400" dark:text-gray-400>/contact for rate</span> --}}
                 </div>
                 <!-- List -->
                 <ul role="list" class="mb-8 space-y-4 text-left">
                     <li class="flex items-center space-x-3">
                         ...
                         <span>Enjoy all the features of the <span class="font-semibold">Free Plan,
                                 plus:</span></span>
                     </li>
                     <li class="flex items-center space-x-3">
                         <!-- Icon -->
                         ...
                         <span><span class="font-semibold">Unlimited QR business cards</span> for comprehensive
                             networking</span>
                     </li>
                     <li class="flex items-center space-x-3">
                         <!-- Icon -->
                         ...
                         <span><span class="font-semibold">Personalized custom URL</span> for each online business
                             card</span>
                     </li>
                     <li class="flex items-center space-x-3">
                         <!-- Icon -->
                         ...
                         <span>Tailor your style with <span class="font-semibold">customizable</span> branding
                             options </span>
                     </li>
                     <li class="flex items-center space-x-3">
                         <!-- Icon -->
